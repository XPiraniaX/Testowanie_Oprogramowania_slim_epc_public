...
from epc_poprawione.models import BearerConfig, ThroughputStats, UEState
...
class EPCRepository:
    ...
    # POPRAWIONE
    # dodano jawne sprawdzanie nr bearerów, wczesniej przy np bearerze 10 wyrzucało ValidationError, teraz ValueError
    def add_bearer(self, ue_id: int, bearer_id: int) -> None:
        if bearer_id < 1 or bearer_id > 9:
            raise ValueError("Bearer ID must be between 1 and 9")
